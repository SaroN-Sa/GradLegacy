...
const TEXT_INPUT_CLASS =
  "w-full pl-11 pr-4 py-2.5 rounded-2xl bg-slate-900 border border-slate-700 text-white text-base sm:text-sm placeholder:text-slate-500 outline-none focus:border-[#FFD700]/60 focus:ring-4 focus:ring-[#FFD700]/10 transition-all";
  ...
  return (
    <div>
      ...
      <form
        ...
        className="space-y-6 rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-5 sm:p-8 shadow-lg shadow-black/20"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-bold text-white">Leave a Graduation Wish</h2>
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            className="w-full px-4 py-3 rounded-2xl bg-slate-900 border border-slate-700 text-white text-base sm:text-sm placeholder:text-slate-500 outline-none focus:border-[#FFD700]/60 focus:ring-4 focus:ring-[#FFD700]/10 transition-all resize-none"
        ...
        {/* Anonymous toggle */}
        <div className="flex items-center justify-between gap-3 rounded-2xl border border-slate-800 bg-slate-900/40 px-4 py-3">
          <div>
