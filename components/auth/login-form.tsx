...
return ( <div className="w-screen min-h-screen flex flex-col lg:flex-row overflow-x-hidden">
  ...
  >
    ...
    <div className="relative z-10">
      ...
      <p
        ...
        "
      >
        Sign in to view wishes,
        memories, photos, videos,
        and your graduation journey.
      </p>
    </div>
  ...
  >
    <div className="w-full max-w-[440px]">
      ...
      <div className="hidden lg:block mb-8">
        <h2 className="text-[2rem] font-extrabold text-[#0f172a]">
          Welcome Back
        </h2>
