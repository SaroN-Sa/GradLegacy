...
export default function TimelineForm({ event, onClose, onCreate, onUpdate }: TimelineFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md h-full bg-gradient-to-b from-slate-900 to-slate-950 border-l border-slate-800 overflow-y-auto animate-slide-in">
